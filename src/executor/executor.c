...
int	execute_pipe(t_ast *node, char **envp, t_myenv *myenv, t_minishell *minishell)
{
	int	fds[2];
	int	status;
	pid_t pid1, pid2;
...
int	execute_and(t_ast *node, char **envp, t_myenv *myenv, t_minishell *minishell)
{
	int	status;
...
int	execute_subshell(t_ast *node, char **envp, t_myenv *myenv, t_minishell *minishell)
{
	pid_t	pid;
	int		status;
